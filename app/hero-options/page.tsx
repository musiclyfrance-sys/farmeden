...
function Opt1() {
  return (
    <section className="bg-[#F5EFE0] overflow-hidden">
      <div className="mx-auto max-w-6xl px-5 md:px-8 grid grid-cols-1 md:grid-cols-2 min-h-screen items-center gap-10">
...
function Opt2() {
  return (
    <section className="bg-[#F5EFE0] relative overflow-hidden min-h-screen flex items-center">
      <div className="mx-auto max-w-6xl px-5 md:px-8 w-full grid grid-cols-1 md:grid-cols-2 items-center gap-10">
        <div className="pt-24 md:pt-0 relative z-10">
          <div className="mb-7"><Stars /></div>
...
function Opt4() {
  return (
    <section className="bg-[#F5EFE0] overflow-hidden min-h-screen flex items-center">
...
export default async function HeroOptions({ searchParams }: { searchParams: Promise<{ n?: string }> }) {
  ...
  const opt = Number(n) || 1;
  const map: Record<number, React.ReactNode> = { 1: <Opt1 />, 2: <Opt2 />, 3: <Opt3 />, 4: <Opt4 />, 5: <Opt5 /> };
  return map[opt] ?? <Opt1 />;
}
