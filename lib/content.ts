...
export const EXPERIENCES: Experience[] = [
  {
    ...
    highlights: [
      ...
      { icon: 'nature', title: 'Animaux à découvrir', text: 'Moutons, chèvres, lapins et paons à observer de près.' },
...
export const DEFAULT_GALLERY: GalleryRubric[] = [
  ...
  },
  {
    id: 'animaux',
    label: 'Les animaux',
    desc: 'Paons, chèvres, lapins et tortues à découvrir sur la propriété. Les enfants adorent les observer.',
    photos: [
      ...
      { id: 'a3', src: '/images/farm/paon-coqs.jpg', alt: 'Paon et coqs à la ferme' },
